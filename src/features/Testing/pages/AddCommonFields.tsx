...
const saudiRegions: SaudiRegions = {
    "الرياض": ["الرياض", "الدرعية", "ضرما", "المزاحمية", "شقراء", "الدوادمي", "وادي الدواسر"],
...
const AddCommonFields: React.FC = () => {
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            <button
                                type="submit"
                                disabled={!reportId.trim() || !inspectionDate || !region || !city || !isLoggedIn || isUpdating}
